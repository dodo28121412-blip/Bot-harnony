...
intents.members = True  # Potrebné pre prístup k rolám členov
...
# Vytvorenie tabuliek bez nebezpečných odsadení
...
async def vyplatazam(interaction: discord.Interaction, hrac: discord.Member):
    ...
    # Nájdeme najvyššie percento podľa rolí, ktoré hráč má
    user_role_ids = [role.id for role in hrac.roles]
    percent = 100.0  # Výchozie percento
